...
| Ett kapat konto kunde spara godtyckligt stort innehåll | Servern granskar längder och antal: max 12 träningspass, max 40 moment per pass, max 60 lekar i lekbanken, 30 000 tecken per moment/lek, 30 bilagor per moment/lek |
